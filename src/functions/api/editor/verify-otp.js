import { codeHash, isAllowedEmail, json, normalizeEmail, signPayload, verifySignedPayload } from '../../_lib/editor-utils.js';
...
export async function onRequestPost({ request, env }) {
  try {
    ...
    return json({ ok: true, token, email, expiresInHours: hours });
  } catch (error) {
